document.addEventListener("DOMContentLoaded", function () {
  ...
  sizeRadio.addEventListener("click", function () {
    ...
    newStockItem.innerHTML = `
            <div class="wrapper wrapper-custom">
                <h2>Stock</h2>
                <textarea class="stock-input" placeholder="Stock..." required></textarea>
            </div>
            <div class="wrapper wrapper-custom">
                <h2>Size</h2>
                <textarea class="size-input" placeholder="Size..." required></textarea>
            </div>
        `;
  ...
  nonSizeRadio.addEventListener("click", function () {
    ...
    newStockItem.innerHTML = `
            <div class="wrapper wrapper-custom">
                <h2>Stock</h2>
                <textarea id="none-size-input" placeholder="Stock..." required></textarea>
            </div>
        `;
    stockSection.appendChild(newStockItem);
  });
