        ...
        <body>
            <div class="email-container">
                ...
                <div class="content">
                    ...
                    <p>Explore our latest collections and discover the perfect piece to complement your style.</p>
                    <p>Should you have any questions or need assistance, our dedicated support team is here to help.</p>
                    <a href="${process.env.APP_CLIENT}/reset-password?email=${email}&token=${token}" class="button" style ="col"">Reset Password</a>
                    </div>
                <div class="footer">
                    <p>&copy; 2024 T&N Jewelry. All rights reserved.</p>
                </div>
...
function verifyChangeEmailHTMLGenerator(email, token) {
  return `<!DOCTYPE html>
        <html>
        <head>
            <meta charset="UTF-8">
        ...
        <body>
            <div class="email-container">
                ...
                <div class="content">
                    ...
                    <p>Explore our latest collections and discover the perfect piece to complement your style.</p>
                    <p>Should you have any questions or need assistance, our dedicated support team is here to help.</p>
                    <a href="${process.env.APP_URL}/customer/verifyEmail?email=${email}&token=${token}" class="button" style ="col"">Verify Email</a>
                    </div>
                <div class="footer">
                    <p>&copy; 2024 T&N Jewelry. All rights reserved.</p>
                </div>
